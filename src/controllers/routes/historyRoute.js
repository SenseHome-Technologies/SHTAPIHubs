...
/**
 * @api {post} /api/history/create Create a history entry
 ...
 */
router.route('/history/create').post(
...
/**
 * @api {get} /api/history/get Get all history entries for a device
...
router.route('/history/get').get(
    ...
    async (req, res) => {
        ...
        try {
            ...
            const history = await historyInteractorPostgres.get({historyGetPersistence}, {token, hubid});
